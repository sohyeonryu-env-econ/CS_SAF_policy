...
# =================================================================================
# 1. Load Target SAF Results (5B target analysis)
# =================================================================================

@load "results_target_5.jld2" equivalent_policies_5 equivalent_solutions_5 target_saf_5 policy_configs_target_5

# =================================================================================
# 2. Calculate Target Emissions from RFS (5B target)
# =================================================================================

# Get RFS solution from 5B target analysis
rfs_solution = equivalent_solutions_5[:rfs]
...
# Save results
@save "results_equivalent_emissions_5.jld2" equivalent_emission_policies equivalent_emission_solutions target_total_emission policy_configs_emission
...
# Save complete results
equivalent_emission_policies_5 = equivalent_emission_policies
equivalent_emission_solutions_5 = equivalent_emission_solutions
results_equiv_emission_analysis_5 = results_equiv_emission_analysis
target_total_emission_5 = target_total_emission
policy_configs_emission_5 = policy_configs_emission
cs_changes_equiv_emission_5 = cs_changes_equiv_emission
ps_land_equiv_emission_5 = ps_land_equiv_emission
gr_changes_equiv_emission_5 = gr_changes_equiv_emission
env_benefits_equiv_emission_5 = env_benefits_equiv_emission
welfare_summary_equiv_emission_5 = welfare_summary_equiv_emission
aac_equiv_emission_5 = aac_equiv_emission
SCC_5 = SCC

@save "results_equivalent_emissions_complete_5.jld2" equivalent_emission_policies_5 equivalent_emission_solutions_5 results_equiv_emission_analysis_5 target_total_emission_5 policy_configs_emission_5 cs_changes_equiv_emission_5 ps_land_equiv_emission_5 gr_changes_equiv_emission_5 env_benefits_equiv_emission_5 welfare_summary_equiv_emission_5 aac_equiv_emission_5 SCC_5


println("\n✓ Complete results with welfare analysis saved to results_equivalent_emissions_complete_5.jld2")
...
@save "results_equivalent_emissions_tables_5.jld2" comparison_tables

println("✓ Comparison tables saved to results_equivalent_emissions_tables_5.jld2")