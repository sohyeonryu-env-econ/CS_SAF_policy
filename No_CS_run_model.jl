# run_model.jl
include(joinpath(@__DIR__, "No_CS_SAFModel.jl")) # load SAFModel.jl from the same directory
...
using .No_CS_SAFModel
using .No_CS_SAFAnalysis
import .No_CS_SAFModel: params, run_scenario, extract_solution, is_solved_and_feasible;
import Pkg;
Pkg.add("JLD2");
using JLD2;
using JuMP;
